...
def backtobedR1():
    ...
    if hasphoto == True:
        ...
        print("You finally recognise them.")
        print("You turn your head to see the other woman in the photo is sitting beside you.")
...
def mirrorR4():
    ...
    print("Your own distorted figure appears in front of you.")
    print("Cuts cover your entire body.")
    print("Blood pours from the wounds.")
    print("The sickness becomes unbearable.")
    print("You vomit, and fall to the floor.")
    print("You lay there for what seems like ages.")
    print("Eventually you feel your body weaken.")
    print("Your eyes begin close as you succumb to the pain.")
    print("As your head falls to the right, you see her face, one last time.")
    print("Your eyes shut.")
    print("You do not wake.")
    print("You didn't keep your promise")
